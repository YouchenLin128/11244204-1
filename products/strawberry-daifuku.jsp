    ...
    <main>
            ...
            <section class="product-detail">
                <div class="product-gallery">
                    <button class="prev">←</button>
                        <img id="productImage" src="picture2/草莓大福.jpg" alt="草莓大福">
                    <button class="next">→</button>
                </div>
                <h2 class="product-title">草莓大福</h2>
                <p class="price">NT$ 150</p>
                <p class="description">
                    軟糯的外皮包裹著細緻的紅豆泥，再搭配鮮嫩多汁的草莓，酸甜交織，口感層次豐富，讓人忍不住一再回味。
                </p>
        ...
        <section class="product-tabs">
            ...
            <div class="tab-content" id="details">
                <h3>商品詳細內容</h3>
                <p>成分：草莓、紅豆餡（紅豆、糖）、麻糬（糯米粉、糖、澱粉）</p>
                <p>草莓新鮮、紅豆餡甜美，麻糬外皮柔軟且有彈性，三者完美融合，帶來酸甜與滑順的口感。</p>
            </div>
