    ...
    <main>
            ...
            <section class="product-detail">
                <div class="product-gallery">
                    <button class="prev">←</button>
                        <img id="productImage" src="picture2/水信玄餅.jpg" alt="水信玄餅">
                    <button class="next">→</button>
                </div>
                <h2 class="product-title">水信玄餅</h2>
                <p class="price">NT$ 150</p>
                <p class="description">
                    如水晶般晶瑩剔透的水信玄餅，內嵌各式精美花卉，入口滑嫩清爽，甜味淡雅，令人驚豔。
                </p>
        ...
        <section class="product-tabs">
            ...
            <div class="tab-content" id="details">
                <h3>商品詳細內容</h3>
                <p>成分：水信玄餅寒天粉、細砂糖、黑糖、水飴、黃豆粉、鹽漬櫻花八朵。</p>
                <p>主要由寒天製成，給予水信玄餅清涼透明的質地，搭配黃豆粉與黑糖蜜增加口感層次。</p>
            </div>
