    ...
    <main>
            ...
            <section class="product-detail">
                <div class="product-gallery">
                    <button class="prev">←</button>
                        <img id="productImage" src="picture2/蕨餅.jpg" alt="蕨餅">
                    <button class="next">→</button>
                </div>
                <h2 class="product-title">蕨餅</h2>
                <p class="price">NT$ 150</p>
                <p class="description">
                    透明如玉的蕨餅，口感Q彈滑嫩，搭配黃豆粉與黑糖醬，甜香四溢，入口即化，讓人回味無窮。
                </p>
        ...
        <section class="product-tabs">
            ...
            <div class="tab-content" id="details">
                <h3>商品詳細內容</h3>
                <p>成分：蕨根粉、糖、黃豆粉、黑糖蜜</p>
                <p>蕨餅的主要成分是蕨根粉，質地柔滑，與黃豆粉和黑糖蜜一起搭配，口感清甜。</p>
            </div>
