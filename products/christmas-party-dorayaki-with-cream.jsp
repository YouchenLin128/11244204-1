    ...
    <main>
        <div class="container">
            ...
            <section class="product-detail">
                <div class="product-gallery">
                        <img id="productImage" src="picture2/聖誕派對生乳銅鑼燒1.jpg" alt="聖誕派對生乳銅鑼燒">
                    <button class="next">→</button>
                </div>
                <h2 class="product-title">聖誕派對生乳銅鑼燒</h2>
                <p class="price">NT$ 150</p>
                <p class="description">
                    銅鑼燒外皮用麵粉、雞蛋和蜂蜜製作，內餡是紅豆餡，夾層則是濃郁的奶油，香滑可口。
                </p>
        ...
        <section class="product-tabs">
            ...
            <div class="tab-content" id="details">
                <h3>商品詳細內容</h3>
                <p>成分：紅豆餡（紅豆、糖）、麵粉、雞蛋、奶油、糖、蜂蜜、泡打粉</p>
            </div>
